...
exports.getPatientStats = exports.updatePatientProfile = exports.getPatientProfile = void 0;
const User_1 = require("../models/User");
const Recovery_1 = require("../models/Recovery"); // ✅ Updated import
...
const updatePatientProfile = async (req, res) => {
    ...
    try {
        ...
        const updated = await User_1.User.findByIdAndUpdate(req.user?.userId, updateData, {
            new: true,
        }).select("-password");
        if (!updated) {
...
const getPatientStats = async (req, res) => {
    ...
    try {
        ...
        const logs = await Recovery_1.Recovery.find({ userId }).sort({ createdAt: 1 });
        ...
        const progressValues = logs
            ...
            .filter((v) => !isNaN(v));
        const averagePain = progressValues.length > 0
